				...
				<div class="col-lg-6">
					<div class="billing checkout_section">
						...
						<div class="checkout_form_container">
							<form action="<?= base_url() ?>index.php/shop/checkOut" id="checkout_form" class="checkout_form" method="post"	>
								<div class="row">
									<div class="col-xl-12">
										<!-- Name -->
									...
									<!-- <div class="col-xl-6 last_name_col"> -->
										<!-- Last Name -->
									<!-- 	<label for="checkout_last_name">ge*</label>
						...
						<!-- 		<div>
								...
								<div>
									...
									<input type="email" id="checkout_email" class="checkout_input" required="required" name="email">
								</div>
								<!-- <div class="checkout_extra">
									<div>
										<input type="checkbox" id="checkbox_terms" name="regular_checkbox" class="regular_checkbox" checked="checked">
										<label for="checkbox_terms"><img src="<?= base_url() ?>assets/frontend/images/check.png" alt=""></label>
										<span class="checkbox_title">Terms and conditions</span>
									</div>
								
								</div> -->
								<!-- <div > --><input type="submit" value="Place Order" class="button order_button"></input><!-- </div> -->
							</form>
						</div>
					</div>
				</div>
					...
					<div class="order checkout_section">
						...
						<div class="order_list_container">
							<div class="order_list_bar d-flex flex-row align-items-center justify-content-start">
								...
								<div class="order_list_value ml-auto">Quantity</div>
							...
							<ul class="order_list">
								...
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div class="order_list_title"><?= $value['name'] ?></div>
									<div class="order_list_value ml-auto"><?= $value['qty'] ?></div>
									<div class="order_list_value ml-auto"><?= $value['subtotal'] ?></div>
								</li>
								<?php endforeach ?>
								<li class="d-flex flex-row align-items-center justify-content-start">
...
<script src="<?= base_url() ?>assets/frontend/js/checkout.js"></script>
</body>
</html>