	...
	<div class="cart_info">
		<div class="container">
			...
			<div class="row cart_items_row">
				<div class="col">
				<form action="<?= base_url() ?>index.php/shop/updateCart" method="post" id="form">
					<!-- Cart Item -->
					...
					<div class="cart_item d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
						...
						<div class="cart_item_product d-flex flex-row align-items-center justify-content-start">
							<div class="cart_item_image">
								<div><img src="<?= base_url() ?>uploads/<?= $value['image'] ?>" alt=""></div>
							</div>
							<div class="cart_item_name_container">
								<div class="cart_item_name"><a href="#"><?= $value['name'] ?></a></div>
								
							</div>
						</div>
						<!-- Price -->
						<div class="cart_item_price"><?= $value['price'] ?></div>
						<!-- Quantity -->
						...
						<div class="cart_item_quantity">
							<div class="product_quantity_container">
								<div class="product_quantity clearfix">
									<span>Qty</span>
									<input id="quantity_input" type="number" pattern="[0-9]*" value="<?= $value['qty'] ?>" name ="<?=$value['rowid']?>">
						...
						<!-- Total -->
						<div class="cart_item_total"><?= $value['subtotal'] ?></div>
					</div>
			...
			<div class="row row_cart_buttons">
				<div class="col">
					<div class="cart_buttons d-flex flex-lg-row flex-column align-items-start justify-content-start">
						<div class="button continue_shopping_button"><a href="<?= base_url() ?>index.php/shop/index">Continue shopping</a></div>
						<div class="cart_buttons_right ml-lg-auto">
							<div class="button clear_cart_button"><a href="<?= base_url() ?>index.php/shop/deleteAll">Clear cart</a></div>
			...
			<div class="row row_extra">
				<div class="col-lg-4">
					...
					<div class="delivery">
						...
						<div class="delivery_options">
							<label class="delivery_option clearfix">Next day deliver
				...
				<div class="col-lg-6 offset-lg-2">
					<div class="cart_total">
						...
						<div class="button checkout_button"><a href="<?= base_url() ?>index.php/shop/showbill">Proceed to checkout</a></div>
					</div>
				</div>
			</div>
		</div>		
